...
@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('tools', 'admin', 'admintoolbox')

            # A URL to the license for this module.
            LicenseUri   = 'https://github.com/vukasinterzic/AdminToolBox/blob/master/license.txt'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/vukasinterzic/AdminToolBox'

            # A URL to an icon representing this module.
            IconUri      = 'https://github.com/vukasinterzic/AdminToolBox/blob/master/images/powershellHero.ico'

            # ReleaseNotes of this module
            ReleaseNotes = 'https://github.com/vukasinterzic/AdminToolBox/blob/master/README.md'
